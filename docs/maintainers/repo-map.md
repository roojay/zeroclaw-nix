...
├── crates/aardvark-sys/  # Aardvark hardware FFI bindings
...
├── docs/                 # Documentation system (en/zh-CN, runtime refs)
...
| `docs/`                                   | Documentation system: en/zh-CN, runtime references, operations runbooks, security proposals                        |
| `.github/`                                | CI workflows, automation                                                                                           |
